...
# this is the linear function for default learner
#        self.epsilon=1.-(self.t-1)*0.05
        
# this is optimized function for improved learner
        self.epsilon=0.99**(self.t-1)
